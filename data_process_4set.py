...
data_root = '../data/251212_G2_Rev_Accumulate'
...
for label_name in os.listdir(data_root):
    ...
    split_point_1 = int(len(image_paths) * 0.25)
    split_point_2 = int(len(image_paths) * 0.50)
    split_point_3 = int(len(image_paths) * 0.75)

    train_image_paths_list = [image_paths[:split_point_3],
    ...
    test_image_paths_list = [image_paths[split_point_3:],
